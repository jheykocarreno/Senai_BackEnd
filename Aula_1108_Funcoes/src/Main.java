...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("10 - Extra 1 - Filtrar números positivos em um array");
            ...
            if  (option == 0) {
                ...
                int qtdPrimos = sc.nextInt();
                int[] array = gerarPrimos(qtdPrimos);
    ...
    //9. Calcular fatorial com recursão
